...
![Seagrass change from 2020 to 2022 for selected seagrass management areas identified by the Tampa Bay Estuary Program.  The left map shows the overall acreage change by management area and the right map shows the areas where seagrass was lost or gained.  See [@fig-map] for the locational context.](figs/seagrasschange.png){#fig-seagrasschange}
